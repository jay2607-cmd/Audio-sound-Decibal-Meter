...
class CameraMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Cameraful(title: 'Circular Video Recorder'),
    );
  }
}
...
class Cameraful extends StatefulWidget {
  const Cameraful({super.key, required this.title});

  final String title;

  @override
  State<Cameraful> createState() => _CamerafulState();
}

class _CamerafulState extends State<Cameraful> {
